...
public class PAssign08 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        call.setOnMousePressed(e -> call.setOpacity(.7));
        call.setOnMouseReleased(e -> call.setOpacity(1));
        ...
        hangUp.setOnMousePressed(e -> hangUp.setOpacity(.7));
        hangUp.setOnMouseReleased(e -> hangUp.setOpacity(1));
        hangUp.setPrefSize(80, 50);
        hangUp.setAlignment(Pos.CENTER);
        hangUp.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
        ...
        KeyPadCustomPane keyPane = new KeyPadCustomPane();
